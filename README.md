...
[![Phoenix](https://img.shields.io/badge/Phoenix-1.7+-E8562A?logo=phoenix-framework)](https://www.phoenixframework.org/)
...
| カテゴリ | 技術 |
|:---|:---|
| 言語 / フレームワーク | Elixir 1.15+ / Phoenix 1.7+ (LiveView) |
...
ブラウザで [`http://localhost:4000/inspector`](http://localhost:4000/inspector) にアクセスしてください。
...
`/inspector` にアクセスし、考古学報告書の PDF ファイルをアップロードします。
...
キャプション（図の説明）とラベル（識別名）を手入力してください。
...
│   └── alchem_iiif_web/
│       ├── live/inspector_live/   # ウィザード LiveView
