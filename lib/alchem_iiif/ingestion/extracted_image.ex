defmodule AlchemIiif.Ingestion.ExtractedImage do
  ...
  def changeset(extracted_image, attrs) do
    ...
    |> validate_length(:site, max: 100, message: "100文字以内で入力してください")
    |> validate_length(:period, max: 100, message: "100文字以内で入力してください")
    |> validate_length(:artifact_type, max: 100, message: "100文字以内で入力してください")
